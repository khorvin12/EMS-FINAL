    ...
    <div class="flex flex-col h-screen">
        <header class="bg-green-600 text-white shadow-md">
            <nav class="flex items-center justify-between p-6 font-bold">
                ...
                <h1 class="text-3xl ml-8">Employee</h1>
                ...
                <div class="mr-6 relative">
                    ...
                    <div v-if="dropdownOpen">
                        ...
                        <div
                            ...
                            <!-- Username -->
                            <div class="text-black text-center font-medium px-8 py-3 border-b text-base">
                                {{ page.props.auth.user.name }}
                            </div>

                            <!-- Profile Link -->
                            <Link href="/employee/profile" class="block px-8 py-2 text-center text-black hover:bg-gray-100">
                                Profile
                            </Link>
