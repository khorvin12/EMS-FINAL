    ...
    <div class="flex flex-col h-screen overflow-hidden">
        <header class="bg-red-700 text-white shadow-md z-20">
            <nav class="flex items-center justify-between p-6 font-bold">
                ...
                <h1 class="text-3xl ml-4">Admin Panel</h1>

                <div class="mr-6 relative">
                    <!-- Dropdown menu button -->
                    <button @click="dropdownOpen = !dropdownOpen"
                        class="relative z-50 w-10 h-10 overflow-hidden rounded-full bg-slate-100 focus:ring-2 focus:ring-white border">

                        <img src="https://picsum.photos/200" class="w-full h-full object-cover">
                    </button>
                    ...
                    <div v-if="dropdownOpen">
                        ...
                        <div
                            ...
                            <!-- Profile Link -->
                            <Link href="/profile"
                                class="block px-8 py-2 text-center text-black hover:bg-gray-100 font-medium">
                                Profile
                            </Link>
