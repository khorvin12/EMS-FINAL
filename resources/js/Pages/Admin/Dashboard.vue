...
<template>
    ...
    <!-- Dashboard Cards -->
    <div class="grid grid-cols-2 justify-items-center gap-6 mb-48">
        ...
        <div class="bg-white rounded-md flex items-center gap-4 shadow w-64">
            <div class="bg-green-500 rounded-md px-5 py-3">
                <i class="fa fa-building fa-2x" aria-hidden="true" />
            </div>
            <div>
    ...
    <div class="grid grid-cols-3 justify-items-center gap-6">
