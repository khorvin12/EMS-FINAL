...
<template>
    <main>
        ...
        <!-- Empty State -->
        <div v-if="leaveTableData.length === 0" class="rounded-lg shadow-md p-12 text-center">
        ...
        <!-- Leave Table -->
        <div v-else class="rounded-lg shadow-md overflow-hidden">
                    ...
                    <thead class="bg-gray-400 text-black font-medium">
                        <tr>
                            <th 
                                ...
                                :key="column.key"
                                :class="[
                                    'px-6 py-4 border-b-2 border-gray-200 font-bold',
