...
<template>
    ...
    <div class="flex flex-col px-6">
        <h2 class="text-4xl font-bold text-center text-gray-900">Your Monthly Salary</h2>
        ...
        <!-- Employee Info -->
        <div class="bg-gray-200 rounded-lg p-7 mb-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div
                class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-8 text-white hover:shadow-xl transition-all hover:-translate-y-1 duration-300">
            ...
            <div class="space-y-3">
                ...
                <div v-if="calculatedSalary.lateDeduction > 0"
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ attendance.late_count }} time(s) late ({{
                ...
                <div v-if="calculatedSalary.overtimePay > 0"
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ attendance.overtime_hours || 0 }} hour(s) overtime
                            (1.25x rate)</p>
                    </div>
