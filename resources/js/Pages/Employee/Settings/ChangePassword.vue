...
<template>
    <div class="flex items-center justify-center h-176">
        <div class="bg-white w-full max-w-sm p-6 rounded-md shadow-md border-5 border-green-600">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="password" v-model="form.current_password"
                        class="w-full p-2 rounded-lg border-2 border-slate-300 focus:outline-none focus:border-blue-400" />
                ...
                <!-- Button -->
                <button type="submit"
                    class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-2 rounded-md mt-4"
