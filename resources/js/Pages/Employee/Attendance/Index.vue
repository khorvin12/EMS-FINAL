...
<template>
    ...
    <div class="flex flex-col px-6">
        <!-- Header Section -->
        <div class="mb-8">
            <h2 class="text-4xl font-bold text-gray-900 mb-2">Attendance Tracker</h2>
            <p class="text-gray-600">{{ currentDate }}</p>
        </div>

        <!-- Clock In/Out Card -->
        <div class="bg-white rounded-xl shadow-lg p-8 mb-8 h-full">

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Left Side - Employee Info & Time -->
                <div>
                    <div class="bg-gray-50 rounded-lg p-8 mb-6">
                        <p class="text-lg text-gray-600 mb-1">Employee ID</p>
                        <p class="text-2xl font-bold text-gray-900 mb-4">{{ employee.id }}</p>

                        <p class="text-lg text-gray-600 mb-1">Name</p>
                        <p class="text-2xl font-bold text-gray-900">{{ employee.name }}</p>
                    </div>

                    <div class="text-center bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-12">
                        <p class="text-lg text-gray-600 mb-2">Current Time</p>
                        <p class="text-6xl font-bold text-gray-900">{{ currentTime }}</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col justify-center mb-6">
                    <!-- Today's Status -->
                    <div v-if="todayAttendance" class="bg-gray-50 rounded-lg p-14 mb-6">
                        <h3 class="text-2xl font-semibold text-gray-900 mb-4">Today's Attendance</h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-if="!canTimeIn && !canTimeOut" class="text-center p-16 bg-gray-50 rounded-lg">
                            <i class="fa fa-check-circle text-green-500 text-4xl mb-2" aria-hidden="true"></i>
