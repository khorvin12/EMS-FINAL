        ...
        <div class="bg-white border-4 border-blue-500 rounded-lg p-8 w-full max-w-2xl shadow-md">
            ...
            <form @submit.prevent="submit">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" v-model="form.date"
                            class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400"
                    ...
                    <div>
                        ...
                        <p v-if="form.errors.check_in" class="text-red-500 text-xs mt-1">{{ form.errors.check_in }}
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p v-if="form.errors.check_out" class="text-red-500 text-xs mt-1">{{ form.errors.check_out }}
                    </p>
                </div>
