...
const calculatedSalary = computed(() => {
    ...
    // Constants should ideally come from backend config
...
const generatePayroll = () => {
    ...
    router.post(`/hr/salaries/${props.employee.employee_id}/generate-payroll`, {}, {
        preserveState: true,
        preserveScroll: true,
...
<template>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-bold text-gray-900">Employee Salary Details</h2>
            <button @click="goBack" class="bg-gray-500 hover:bg-gray-600 text-white font-medium px-6 py-2 rounded-md transition-colors">
                ← Back to List
            </button>
        </div>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm mb-4">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="text-2xl font-bold" :class="attendance.total_hours_worked >= attendance.expected_hours ? 'text-green-600' : 'text-orange-600'">
    ...
    <p class="text-sm text-green-600 font-semibold">✓ Full Hours Completed</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <p class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Late Arrivals</p>
