                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div
                        ...
                        <div class="text-xs space-y-1 mt-2">
                            <p v-if="!payrollGenerated" class="text-gray-400 italic">
                                Pending generation...
                            </p>

                            <template v-else>
                                <p v-if="attendance.absences > 0" class="text-red-600">
                                    Absence: -₱{{ formatCurrency(calculatedSalary.absenceDeduction) }}
                                </p>

                                <p v-if="attendance.late_count > 0" class="text-orange-600">
                                    Late: -₱{{ formatCurrency(calculatedSalary.lateDeduction) }}
                                </p>

                                <p v-if="attendance.undertime_hours > 0" class="text-red-600">
                                    Undertime: -₱{{ formatCurrency(calculatedSalary.undertimeDeduction) }}
                                </p>

                                <p v-if="attendance.overtime_hours > 0" class="text-green-600">
                                    Overtime: +₱{{ formatCurrency(calculatedSalary.overtimePay) }}
                                </p>
                    ...
                    <div
                        ...
                        <p class="text-xs font-semibold uppercase tracking-wide mb-2 opacity-90">
                            Net Salary
                        </p>
